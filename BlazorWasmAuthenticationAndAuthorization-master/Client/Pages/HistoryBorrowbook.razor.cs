...
{
    public class HistoryBorrowbookBase : ComponentBase
    {
        [Inject]
        ...
        {
            borrowbooksList = await Http.GetFromJsonAsync<List<BlazorWasmAuthenticationAndAuthorization.Shared.Refactored.Borrowbooks>>("api/Borrowbooks/History");
